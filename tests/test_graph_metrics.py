...
def test_triple_f1_empty_gold_and_pred():
    ...
    assert p == r == f1 == 1.0        # ambos vacíos = acuerdo perfecto


def test_graph_edit_distance_proxy():
    # GED-proxy normalizado: |dif simétrica de nodos| + |dif simétrica de aristas|
...
def test_graph_edit_distance_normalized():
    ...
    assert n == 1.0                                    # todo distinto -> distancia máxima
